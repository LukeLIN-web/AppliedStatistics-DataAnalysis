...
I set the same y scales in both graphs.  The first boxplot shows the speed with the right dominant hand has higher mean, and wider range. The second boxplot shows the speed with the non-dominant hand, if the right hand is dominant hand, has lower mean. 
Compare two boxplots, we can find that the speed with the non-dominant hand has lower mean than the speed with the dominant hand. 
